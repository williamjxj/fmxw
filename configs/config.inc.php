...
defined('ROWS_PER_PAGE') or define('ROWS_PER_PAGE', 30);
defined('ROWS_PER_PAGE_10') or define('ROWS_PER_PAGE_10', 10);
...
if (!isset($config)) {
  $config = array(
    ...
    'js' => array(
        ...
        'fmxw' => 'js/dixi.js',
        'jqueryui' => 'include/jqueryui/js/jquery-ui-1.8.22.custom.min.js', 
    ),
    'f0' => array(
        'c' => 'css/f0.css', 
        'l' => 'locale/f0.inc.php', 

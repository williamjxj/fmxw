...
if (isset($_GET['q'])) {
	...
	if(empty($_GET['q'])) {
		...
		$key ='@title "'.$q.'" @* (丑闻|曝光|乱|腐|贿|淫|荡|娼|滥|罪|恶|霸|贬|讹|劫|燥|偷|癌|窃|狡|诈|毒|害|坏|谎|病|贪|奸|苦|哭|污|诱|惑|魔鬼|过期|变质|假|邪|落后|自私|蛮荒|姑息|愚昧|欺|诈|悲剧|消极|放纵|虚假|倒台|烦|危机|霉|温床|败|试探|次品|舆论|绯闻|露点|情妇|小三|流氓|辩解|卖国|浪尖|愤怒|逃避|媒体|作秀|负面|新闻|评价|真相|障碍|恐慌|暧昧|流言|话题|炒作|不公|扒光|暴发户)';

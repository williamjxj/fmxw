...
if (isset($_GET['q'])) {
	...
	if(empty($_GET['q'])) {
		...
		$key ='@title "'.$q.'" @* (丑闻|曝光|腐败|贿赂|淫荡|娼妓|滥用|罪恶|讹诈|抢劫|浮躁|偷窃|狡诈|毒害|奸污|诱惑|贪污|魔鬼|过期|变质|掺假|邪恶|疾病|落后|贪心|自私|蛮横|贪婪|姑息|愚昧|假冒|欺诈|悲剧|消极|放纵|虚假|欺骗|倒台|麻烦|厌烦|危机|倒霉|温床|腐败|谎言|试探|次品|舆论|绯闻|露点|情妇|流氓|恶霸|犯罪|辩解|暴发户|浪尖|愤怒|逃避|作恶|作秀|负面|真相|致癌|涉嫌|超标|贬低|炒作|坏)';
